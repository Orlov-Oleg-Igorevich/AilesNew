...
class PersonInfo(models.Model):
    ...
    photo = models.ImageField(blank=True, upload_to='person_photo')
    profile_hat = models.ImageField(blank=True, upload_to='person_photo/hats')
    occupation = models.CharField(max_length=100, blank=True)
    photos = models.ManyToManyField('PersonPhotos', related_name='user', verbose_name='Фотография профиля')
